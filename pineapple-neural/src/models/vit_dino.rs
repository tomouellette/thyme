// NOTE: This implemention of the DINOv2 models from Meta Research was sourced/pasted from
// huggingface candle github repository. A direct copy was requried to modify the forward
// pass as methods were private.
//
// https://github.com/huggingface/candle/blob/main/candle-transformers/src/models/dinov2.rs
...
impl DinoVisionTransformer {
    pub fn new(
        ...
        let patch_embed =
            PatchEmbed::new(vb.pp("patch_embed"), image_size, patch_size, 3, embed_dim)?;
    ...
    fn interpolate_pos_encoding(&self, xs: &Tensor, w: usize, h: usize) -> Result<Tensor> {
        ...
        if npatch == n && w == h {
            return Ok(self.pos_embed.clone()); // See: https://github.com/huggingface/candle/issues/2286
        }
